...
BEGIN
    ...
    IF NEW.ma_kh IS NOT NULL THEN
        -- Cứ 10.000 VNĐ = 1 điểm (vd 210.000 = 21 điểm)
        SET points_earned = FLOOR(NEW.tong_tien / 10000);
...
BEGIN
    ...
    SET old_points = FLOOR(OLD.tong_tien / 10000);
    SET new_points = FLOOR(NEW.tong_tien / 10000);
...
db.query(sql, (err, result) => {
    if(err) {
        ...
        console.log("Cập nhật rule tính điểm trigger thành công!");
    }
    db.end();
});
